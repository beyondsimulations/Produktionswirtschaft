...
Cyber Systems steht vor der Herausforderung, die Montage ihrer neuesten T-800 Endoskelett-Arme zu optimieren. In der Endmontage gibt es eine einzelne Station, die für die finale Qualitätsprüfung und Kalibrierung zuständig ist. Für eine Charge von 6 Armen sind die Bearbeitungszeiten (in Stunden) für diese Station bekannt. Die Aufträge sind in der Reihenfolge ihres Eintreffens (FCFS) nummeriert.
...
fig.suptitle('Vergleich FCFS vs. KOZ bei Cyberdyne Systems', fontsize=14)
...
2.  Wenden Sie nun das **Hodgson-Verfahren (auch Moore-Hodgson-Algorithmus genannt)** an, um die Anzahl der verspäteten Aufträge zu minimieren. 
...
```{python}
#| label: fig-task2
#| fig-cap: "Produktionsplan Weyland-Yutani Komponenten"
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
...
print("Ursprüngliche Auftragsdaten Weyland-Yutani:")
print(df_task2)
...
fig_task2, ax_task2 = plt.subplots(figsize=(10, 3))
...
ax_task2.set_title('Gantt-Diagramm (Hodgson-Verfahren) - Weyland-Yutani')
...
```{python}
#| label: fig-task3
#| fig-cap: "Produktionsplan Stark Industries (Johnson-Algorithmus)"
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
...
print("Ursprüngliche Auftragsdaten Stark Industries:")
print(df_task3)
...
fig_task3, ax_task3 = plt.subplots(figsize=(12, 4))
...
ax_task3.set_title(f'Gantt-Diagramm Stark Industries (Makespan: {makespan_johnson}h)')
