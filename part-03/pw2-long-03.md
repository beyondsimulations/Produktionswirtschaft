...
für alle $t=1,2, \ldots, T$Minimiere $Z=\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} h_{k} \cdot L_{k t}+\sum_{t=1}^{T} u_{t} \cdot U_{t}+\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} c_{k}^{\mathrm{B}} \cdot B_{k t}+\sum_{k \in \mathcal{K}} c_{k}^{\mathrm{P}} \cdot \sum_{t=1}^{T} d_{k t}$
u. B. d. R.:
...
für alle $t=1,2, \ldots, T$Minimiere $Z=\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} h_{k} \cdot L_{k t}+\sum_{t=1}^{T} u_{t} \cdot U_{t}+\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} c_{k}^{\mathrm{B}} \cdot B_{k t}+\sum_{k \in \mathcal{K}} c_{k}^{\mathrm{P}}\left(\sum_{t=1}^{T} d_{k t}-\sum_{t=1}^{T} B_{k t}\right)$
u. B. d. R.:
...
für alle $t=1,2, \ldots, T$Minimiere $Z=\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} h_{k} \cdot L_{k t}+\sum_{t=1}^{T} u_{t} \cdot U_{t}+\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} c_{k}^{\mathrm{B}} \cdot B_{k t}+\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} c_{k}^{\mathrm{P}} \cdot d_{k t}-\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} c_{k}^{\mathrm{S}} \cdot d_{k t}$
u. B. d. R.:
...
für alle $t=1,2, \ldots, T$Minimiere $Z=\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} h_{k} \cdot L_{k t}+\sum_{t=1}^{T} u_{t} \cdot U_{t}+\sum_{k \in \mathcal{K}} \sum_{t=1}^{T}\left(c_{k}^{\mathrm{B}}-c_{k}^{\mathrm{P}}\right) \cdot B_{k t}+\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} c_{k}^{\mathrm{P}} \cdot d_{k t}$
u. B. d. R.:
...
| 11 | 352.0 | 500 | 260 | 260 | 0 | 100 |
| 12 | 437.5 | 500 | 260 | 260 | 0 | 100 |# Beispiel II 3 Produkte, 12 Perioden 
...
$c_{1}^{\mathrm{B}^{\prime}}=5, c_{2}^{\mathrm{B}^{\prime}}=10, c_{3}^{\mathrm{B}^{\prime}}=5$# Beschäftigungsglättung: Modell AGGRPLAN 

## Beispiel II 3 Produkte, 12 Perioden

$c_{1}^{\mathrm{B}^{\prime}}=15, c_{2}^{\mathrm{B}^{\prime}}=20, c_{3}^{\mathrm{B}^{\prime}}=15$# Beispiel II 3 Produkte, 12 Perioden 
...
| 10 | 204.5 | 500 | 206 | 260 | 0 | 100 |
| 11 | 352.0 | 500 | 260 | 260 | 0 | 100 |
| 12 | 487.5 | 500 | 260 | 260 | 100 | 100 |# Erweitertes Modell (II): Mehrere Fabriken![img-16.jpeg](img-16.jpeg)# Beschäftigungsglättung: Mehrere Fabriken 

(©) Univ.-Prof. Dr. Michael Manitz# Beschäftigungsglättung: Mehrere Fabriken 

## Annahmen:

$>$ - wie Grundmodell -# Beschäftigungsglättung: Mehrere Fabriken 

## Annahmen:

$>$ - wie Grundmodell -
$>$ mehrere Fabriken $s \in \mathcal{S}$# Beschäftigungsglättung: Mehrere Fabriken 

Annahmen:

- wie Grundmodell -
$>$ mehrere Fabriken $s \in \mathcal{S}$
$>$ fabrikspezifische Produktionsprogramme und Nachfrage# Beschäftigungsglättung: Mehrere Fabriken 

Annahmen:

- wie Grundmodell -
$>$ mehrere Fabriken $s \in \mathcal{S}$
> fabrikspezifische Produktionsprogramme und Nachfrage
$\mathcal{K}_{s} \ldots$ Menge der in Fabrik $s$ gefertigten Produkte# Beschäftigungsglättung: Mehrere Fabriken 
...
Erweiterung der Zielfunktion: Transportkosten# Beschäftigungsglättung: Mehrere Fabriken 
...
- fabrikspezifische Produktionsprogramme und Nachfrage
$\mathcal{K}_{s} \ldots$ Menge der in Fabrik $s$ gefertigten Produkte
- Erweiterung der Zielfunktion: Transportkosten
$c_{k}^{\mathrm{T}(s i)} \ldots$ Transportkostensatz von Produkt $k$ von Fabrik $s$ nach $i$# Beschäftigungsglättung: Mehrere Fabriken 
...
für alle $t=1,2, \ldots, T$Minimiere $Z=\sum_{s \in \mathcal{S}}\left(\sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} h_{k}^{(s)} \cdot L_{k t}^{(s)}+\sum_{t=1}^{T} u_{t}^{(s)} \cdot U_{t}^{(s)}\right)$
u. B. d. R.:
...
$$
L_{k, t-1}^{(s)}+x_{k t}^{(s)}-L_{k t}^{(s)}=d_{k t}^{(s)} \quad \text { für alle } s \in \mathcal{S}, k \in \mathcal{K}_{s} \text { und } t=1,2, \ldots, T
$$
...
Produktionswirtschaft IIMinimiere $Z=\sum_{s \in \mathcal{S}}\left(\sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} h_{k}^{(s)} \cdot L_{k t}^{(s)}+\sum_{t=1}^{T} u_{t}^{(s)} \cdot U_{t}^{(s)}\right)+\sum_{s \in \mathcal{S}} \sum_{i \in \mathcal{S}} \sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} c_{k}^{\mathrm{T}^{(s i)}} \cdot T_{k t}^{(s i)}$
u. B. d. R.:
...
![img-17.jpeg](img-17.jpeg)Minimiere $Z=\sum_{s \in \mathcal{S}}\left(\sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} h_{k}^{(s)} \cdot L_{k t}^{(s)}+\sum_{t=1}^{T} u_{t}^{(s)} \cdot U_{t}^{(s)}\right)+\sum_{s \in \mathcal{S}} \sum_{i \in \mathcal{S}} \sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} c_{k}^{\mathrm{T}^{(s i)}} \cdot T_{k t}^{(s i)}$
u. B. d. R.:
...
Produktionswirtschaft II# Beschäftigungsglättung: Mehrere Fabriken 

$Z=\sum_{s \in \mathcal{S}}\left(\sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} h_{k}^{(s)} \cdot L_{k t}^{(s)}+\sum_{t=1}^{T} u_{t}^{(s)} \cdot U_{t}^{(s)}\right)+\sum_{s \in \mathcal{S}} \sum_{i \in \mathcal{S}} \sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} c_{k}^{\mathrm{T}^{(s i)}} \cdot T_{k t}^{(s i)}$
u. B. d. R.:
...
$$
L_{k, t-1}^{(s)}+x_{k t}^{(s)}+\sum_{j \in \mathcal{S}} T_{k t}^{(j s)}-\sum_{i \in \mathcal{S}} T_{k t}^{(s i)}-L_{k t}^{(s)}=d_{k t}^{(s)}
$$
...
für alle $s \in \mathcal{S}$ und $t=1,2, \ldots, T$$Z=\sum_{s \in \mathcal{S}}\left(\sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} h_{k}^{(s)} L_{k t}^{(s)}+\sum_{t=1}^{T} u_{t}^{(s)} U_{t}^{(s)}\right)+\sum_{s \in \mathcal{S}} \sum_{i \in \mathcal{S}} \sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} c_{k}^{\mathrm{T}^{(s i)}} T_{k t}^{(s i)}$
u. B. d. R.:
...
$$
L_{k, t-1}^{(s)}+x_{k t}^{(s)}+\sum_{j \in \mathcal{S}} T_{k t}^{(j s)}-\sum_{i \in \mathcal{S}} T_{k t}^{(s i)}-L_{k t}^{(s)}=d_{k t}^{(s)} \quad \forall s, k, t
$$
...
für alle $s \in \mathcal{S}$ und $t=1,2, \ldots, T$# Beschäftigungsglättung: Mehrere Fabriken, Lieferanten 

$Z=\sum_{s \in \mathcal{S}}\left(\sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T}\left(h_{k}^{(s)} L_{k t}^{(s)}+c_{k s}^{\mathrm{P}} x_{k t}^{(s)}+c_{k s}^{\mathrm{B}} B_{k t}^{(s)}\right)+\sum_{t=1}^{T} u_{t}^{(s)} U_{t}^{(s)}\right)+\sum_{s \in \mathcal{S}} \sum_{i \in \mathcal{S}} \sum_{k \in \mathcal{K}_{s}} \sum_{t=1}^{T} c_{k}^{\mathrm{T}^{(s i)}} T$
u. B. d. R.:
...
für alle $s \in \mathcal{S}$ und $t=1,2, \ldots, T$# Mehrstufige Ansätze![img-18.jpeg](img-18.jpeg)![img-19.jpeg](img-19.jpeg)
...
$>$ - wie bisher -# Beschäftigungsglättung: Mehrstufiger Ansatz 

## Annahmen:

$>$ - wie bisher -
Direktbedarfskoeffizienten# Beschäftigungsglättung: Mehrstufiger Ansatz 

Annahmen:

-     - wie bisher -
Direktbedarfskoeffizienten
$a_{k j} \ldots$ Anzahl Mengeneinheiten von Produkt $k$, die in eine Mengeneinheit von Produkt $j$ eingehen# Beschäftigungsglättung: Mehrstufiger Ansatz 
...
- Erweiterung Lagerbilanzgleichung -# Beschäftigungsglättung: Mehrstufiger Ansatz 
...
$L_{k, t-1}^{(s)}+x_{k t}^{(s)}-L_{k t}^{(s)}=d_{k t}^{(s)}$
für alle $s \in \mathcal{S}, k \in \mathcal{K}_{s}, t \in\{1, \ldots, T\}$# Beschäftigungsglättung: Mehrstufiger Ansatz 
...
- Erweiterung Lagerbilanzgleichung -
$L_{k, t-1}+x_{k t}-L_{k t}=d_{k t}$
für alle $k \in \mathcal{K}, t \in\{1, \ldots, T\}$# Beschäftigungsglättung: Mehrstufiger Ansatz 
...
$$
L_{k, t-1}+x_{k t}+B_{k t}-\sum_{j \in \mathcal{K}} a_{k j} \cdot x_{j t}-L_{k t}=d_{k t} \text { für alle } k \in \mathcal{K} \text { und } t=1,2, \ldots, T
$$

Verfügbare technische Kapazität in Periode $t$ :

$$
\sum_{k \in \mathcal{K}_{s}} f_{k}^{\mathrm{T}} \cdot x_{k t} \leq b_{t}^{\mathrm{T}^{(s)}} \quad \text { für alle } s \in \mathcal{S} \text { und } t=1,2, \ldots, T
$$
...
Produktionswirtschaft II# Beispiel I 2 Endprodukte, 4 Perioden 

Es werden 2 Produkte hergestellt: A und B. Zusätzlich gibt es ein Vorprodukt C, das in einer zweiten Fabrik gefertigt wird. Die Direktbedarfskoeffizienten in bezug auf $A$ und $B$ betragen 1 Mengeneinheit. Die Daten für die Produkte A und B entsprechen denen des Beispiels I.

Weitere Daten:
$d_{\mathrm{C}}=0$ ME (Mengeneinheiten)
$(t=1,2,3,4)$
$f_{\mathrm{C}}^{\mathrm{T}}=1$ ZE (Zeiteinheiten) pro ME, $f_{\mathrm{C}}^{\mathrm{P}}=1$ ZE pro ME
$(t=1,2,3,4)$
$b_{t}^{\mathrm{T}^{(2)}}=500 \mathrm{ZE}, b_{t}^{\mathrm{P}^{(2)}}=320 \mathrm{ZE}$
$(t=1,2,3,4)$
$U_{t}^{\max (2)}=100 \mathrm{ZE}$
$(t=1,2,3,4)$
$h_{\mathrm{C}}=1.5$ GE pro ZE und ME
$u_{t}^{(2)}=5$ GE pro ZE
$(t=1,2,3,4)$
$L_{\mathrm{C}}^{(0)}=0 \mathrm{ME}$# Beispiel I 2 Produkte, 4 Perioden 

Optimale Lösung:

| Periode $t$ | $d_{\mathrm{A}, t}$ | $x_{\mathrm{A}, t}$ | $L_{\mathrm{A}, t}$ | $d_{\mathrm{B}, t}$ | $x_{\mathrm{B}, t}$ | $L_{\mathrm{B}, t}$ | $d_{\mathrm{C}, t}$ | $x_{\mathrm{C}, t}$ | $L_{\mathrm{C}, t}$ |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 0 |  |  | 36 |  |  | 220 |  |  | 0 |
| 1 | 100 | 64 | 0 | 200 | 60 | 80 | 0 | 124 | 0 |
| 2 | 90 | 90 | 0 | 190 | 115 | 5 | 0 | 205 | 0 |
| 3 | 110 | 110 | 0 | 210 | 205 | 0 | 0 | 315 | 0 |
| 4 | 100 | 100 | 0 | 200 | 200 | 0 | 0 | 300 | 0 |# Beispiel I 2 Produkte, 4 Perioden 
...
| 2 | 90 | 90 | 0 | 190 | 115 | 5 | 0 | 205 | 0 |
| 3 | 110 | 110 | 0 | 210 | 205 | 0 | 0 | 315 | 0 |
| 4 | 100 | 100 | 0 | 200 | 200 | 0 | 0 | 300 | 0 |


| Periode $t$ | $\sum_{k \in\{\mathrm{~A}, \mathrm{~B}\}} f_{k}^{\mathrm{T}} \cdot x_{k t}$ | $b_{t}^{\mathrm{T}^{(1)}}$ | $\sum_{k \in\{\mathrm{~A}, \mathrm{~B}\}} f_{k}^{\mathrm{P}} \cdot x_{k t}$ | $b_{t}^{\mathrm{P}^{(1)}}$ | $U_{t}^{(1)}$ | $U_{t}^{\max (1)}$ |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| 1 | 94.0 | 250 | 92.0 | 160 | 0.0 | 100 |
| 2 | 147.5 | 250 | 160.0 | 160 | 0.0 | 100 |
| 3 | 212.5 | 250 | 160.0 | 160 | 100.0 | 100 |
| 4 | 200.0 | 250 | 160.0 | 160 | 90.0 | 100 |# Beispiel I 2 Produkte, 4 Perioden 
...
| 2 | 147.5 | 250 | 160.0 | 160 | 0.0 | 100 |
| 3 | 212.5 | 250 | 160.0 | 160 | 100.0 | 100 |
| 4 | 200.0 | 250 | 160.0 | 160 | 90.0 | 100 |

$U_{t}^{(2)}=0$
$(t=1,2,3,4)$# Hauptproduktions- 

programmplanungHauptproduktionsprogrammplanung
MERCATOR
(c) Univ.-Prof. Dr. Michael Manitz

Produktionswirtschaft II
$86-1$# Hauptproduktionsprogrammplanung 

Ziele
$\triangleright$ kostenminimale Glättung der Kapazitätsnutzung im Zeitablauf# Hauptproduktionsprogrammplanung 

Ziele
$\triangleright$ kostenminimale Glättung der Kapazitätsnutzung im Zeitablauf (= „Beschäftigungsglättung")# Hauptproduktionsprogrammplanung 
...
$\triangleright$ Festlegung und Koordinierung der dezentralen, mengen- und terminmäßig spezifizierten Produktionsprogramme für einen mittelfristigen Zeitraum# Hauptproduktionsprogrammplanung 
...
(= „Hauptproduktionsprogrammplanung")# Hauptproduktionsprogrammplanung 
...
$\triangleright$ Lagerbestände# Hauptproduktionsprogrammplanung 
...
$\triangleright$ Lagerbestände
Daten
$\triangleright$ Nachfragemengen (Absatzprognosen)
$\triangleright$ Kapazitäten# Hauptproduktionsprogrammplanung 
...
(vgl. Günther/Tempelmeier (2016))# "Rough Cut Capacity Planning"# "Rough Cut Capacity Planning" 

## "DOUBLE" PROGRESS

![img-21.jpeg](img-21.jpeg)# „Rough Cut Capacity Planning" 

## (1) Absatzplan (Synchronisationsprinzip)

| Periode <br> Produkt | 1 | 2 | 3 | 4 | 5 | 6 |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| P1 | 100 | 80 | 120 | 100 | 120 | 60 |
| P2 | 40 | 0 | 60 | 0 | 40 | 0 |# „Rough Cut Capacity Planning" 
...
(2) Globale Belastungsfaktoren (Kapazitätsbelastung pro ME)

| Produktionssegment | P1 | P2 |
| :--: | :--: | :--: |
| A | 0.4 | 1.6 |
| B | 0.6 | 2.4 |
| C | 2.0 | 2.0 |# „Rough Cut Capacity Planning" 
...
(3) Gesamte periodenbezogene Kapazitätsbelastung

| Periode | 1 | 2 | 3 | 4 | 5 | 6 |
| :--: | :--: | :--: | :--: | :--: | :--: | :--: |
| A | 104 | 32 | 144 | 40 | 112 | 24 |
| B | 156 | 48 | 216 | 60 | 168 | 36 |
| C | 280 | 160 | 360 | 200 | 320 | 120 |# „Rough Cut Capacity Planning" 
...
| A | 104 | 32 | 144 | 40 | 112 | 24 |
| B | 156 | 48 | 216 | 60 | 168 | 36 |
| C | 280 | 160 | 360 | 200 | 320 | 120 |

[^0]
[^0]:    (c) Univ.-Prof. Dr. Michael Manitz

    Produktionswirtschaft II
    $=[b_{j t}]_{\text {Segmente } \times \text { Perioden }}$# „Rough Cut Capacity Planning" 
...
$=\left[b_{j t}\right]_{\text {Segmente } \times \text { Perioden }}$# „Rough Cut Capacity Planning" 
...
[^0]:    (C) Univ.-Prof. Dr. Michael Manitz
    ...
    Produktionswirtschaft II# „Rough Cut Capacity Planning" 
...
|  |  |
| :--: | :--: |
| $\sum_{k \in \mathcal{K}} f_{j k} \cdot x_{k t}$ |  |
| $\sum_{k \in \mathcal{K}} f_{j k} \cdot x_{k t}$ |  |
...
[^0]
[^0]:    (c) Univ.-Prof. Dr. Michael Manitz# „Rough Cut Capacity Planning" 
...
[^0]:    (C) Univ.-Prof. Dr. Michael Manitz
    ...
    Produktionswirtschaft II
    88-12# „Rough Cut Capacity Planning" 
...
[^0]:    (C) Univ.-Prof. Dr. Michael Manitz
    ...
    Produktionswirtschaft II
    $=\mathbf{F} \cdot \mathbf{P}=\mathbf{B} \neq \mathbf{P} \cdot \mathbf{F}$# "Rough Cut Capacity Planning" 

## "DOOR

© Univ.-Prof. Dr. Michael Manitz
Produktionswirtschaft II
88-16# "Rough Cut Capacity Planning" 

Kritische Beurteilung:# „Rough Cut Capacity Planning" 

Kritische Beurteilung:
„Pläne" sind i. d. R. nicht durchführbar# „Rough Cut Capacity Planning" 
...
„Rough Cut Capacity Planning" ist lediglich eine Zulässigkeitsprüfung# „Rough Cut Capacity Planning" 

Kritische Beurteilung:
„Pläne" sind i. d. R. nicht durchführbar
„Rough Cut Capacity Planning" ist lediglich eine Zulässigkeitsprüfung
Synchronisationsprinzip ist selten optimal# „Rough Cut Capacity Planning" 

Kritische Beurteilung:
„Pläne" sind i. d. R. nicht durchführbar
„Rough Cut Capacity Planning" ist lediglich eine Zulässigkeitsprüfung
Synchronisationsprinzip ist selten optimal
eine evtl. zeitliche Aufteilung der Kapazitätsbelastung auf mehrere Vorperioden wird nicht berücksichtigt# Kapazitierte Hauptproduktionsprogrammplanung# Modell HPPPLAN# Modell HPPPLAN 

## Indexmengen:

- $\mathcal{J}$... die Menge der zu betrachtenden Produktionssegmente
- K... die Menge der betrachteten Produkte# Modell HPPPLANJ 

Indexmengen:
$\mathcal{J}$... die Menge der zu betrachtenden Produktionssegmente
$\mathcal{K} \ldots$ die Menge der betrachteten Produkte
Variablen:
$x_{k t} \ldots$ die Produktionsmenge für Produkt $k$ in Periode $t$# Modell HPPPLANJ 
...
Variablen:
$x_{k t} \ldots$ die Produktionsmenge für Produkt $k$ in Periode $t$
$L_{k t} \ldots$ der Lagerbestand für Produkt $k$ in Periode $t$# Modell HPPPLANJ 
...
$x_{k t} \ldots$ die Produktionsmenge für Produkt $k$ in Periode $t$
$L_{k t} \ldots$ der Lagerbestand für Produkt $k$ in Periode $t$
$U_{j t} \ldots$ die Zusatzkapazität (Überstunden) in Segment $j$ in Periode $t$# Modell HPPPLANJ 
...
Daten:
$d_{k t} \ldots$ die Nachfragemenge für Produkt $k$ in Periode $t$# Modell HPPPLANJ 
...
Daten:
$d_{k t} \ldots$ die Nachfragemenge für Produkt $k$ in Periode $t$
$b_{j t} \ldots$ die maximale Kapazität in Segment $j$ in Periode $t$![img-22.jpeg](img-22.jpeg)# Hauptproduktionsprogrammplanung 
...
(Beispiel aus Günther/Tempelmeier (2007))# Hauptproduktionsprogrammplanung 
...
$f_{j k z}$... durch Produkt $k$ verursachte Kapazitätsbelastung von Produktionssegment $j$ in der Vorlaufperiode $z$ ( $=$,,Kapazitätsbelastungsfaktor")# Kapazitätsbelastungsprofil 
...
$1 \cdot x_{\mathrm{A} t}+2 \cdot x_{\mathrm{B} t} \leq b_{1 t}+U_{1 t}$# Kapazitätsbelastungsprofil 
...
$4 \cdot x_{\mathrm{A}, t+1}+3 \cdot x_{\mathrm{B}, t+1} \leq b_{2 t}+U_{2 t}$# Kapazitätsbelastungsprofil 
...
Daten:
$d_{k t} \ldots$ die Nachfragemenge für Produkt $k$ in Periode $t$
$b_{j t} \ldots$ die maximale Kapazität in Segment $j$ in Periode $t$# Modell HPPPLANJ 
...
$f_{j k z} \ldots$ die Kapazitätsbelastungsfaktoren# Modell HPPPLANJ 
...
$U_{j t}^{\max } \ldots$ die maximale Zusatzkapazität in Segment $j$ in Periode $t$# Modell HPPPLAN 

Daten - Fortsetzung -:# Modell HPPPLAN 

Daten - Fortsetzung -:

- $Z_{k} \ldots$ die für Produkt $k$ zu berücksichtigende maximale Vorlaufzeit# Modell HPPPLANJ 

Daten - Fortsetzung -:
$Z_{k} \ldots$ die für Produkt $k$ zu berücksichtigende maximale Vorlaufzeit
$L_{k}^{(0)} \ldots$ der Anfangslagerbestand für Produkt $k$# Modell HPPPLANJ 

Daten - Fortsetzung -:
$Z_{k} \ldots$ die für Produkt $k$ zu berücksichtigende maximale Vorlaufzeit
$L_{k}^{(0)} \ldots$ der Anfangslagerbestand für Produkt $k$
$h_{k} \ldots$ der Lagerkostensatz für Produkt $k$# Modell HPPPLANJ 

Daten - Fortsetzung -:
$Z_{k} \ldots$ die für Produkt $k$ zu berücksichtigende maximale Vorlaufzeit
$L_{k}^{(0)} \ldots$ der Anfangslagerbestand für Produkt $k$
$h_{k} \ldots$ der Lagerkostensatz für Produkt $k$
$u_{t} \ldots$ der Kostensatz für Zusatzkapazität in Periode $t$# Modell HPPPLAN# Modell HPPPLAN 

Minimiere $Z=\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} h_{k} \cdot L_{k t}+\sum_{t=1}^{T} \sum_{j \in \mathcal{J}} u_{t} \cdot U_{j t}$# Modell HPPPLAN 

Minimiere $Z=\sum_{k \in \mathcal{K}} \sum_{t=1}^{T} h_{k} \cdot L_{k t}+\sum_{t=1}^{T} \sum_{j \in \mathcal{J}} u_{t} \cdot U_{j t}$
u. B. d. R.:# Modell HPPPLANJ 
...
für alle $k \in \mathcal{K}$# Modell HPPPLANJ 
...
für alle $k \in \mathcal{K}$
Lagerbilanzgleichung für Produkt $k$ in Periode $t$ :# Modell HPPPLANJ 
...
für alle $k \in \mathcal{K}$ und $t=1,2, \ldots, T$# Modell HPPPLANI 
...
für alle $k \in \mathcal{K}$ und $t=1,2, \ldots, T$
Verfügbare Kapazität in Segment $j$ in Periode $t$ :# Modell HPPPLANJ 
...
$$
\sum_{k \in \mathcal{K}} f_{j k} \cdot x_{k, t} \leq b_{j t}
$$

für alle $j \in \mathcal{J}, t=1,2, \ldots, T$# Modell HPPPLANJ 
...
$$
\sum_{k \in \mathcal{K}} f_{j k} \cdot x_{k, t} \leq b_{j t}+U_{j t}
$$
...
$$
\sum_{k \in \mathcal{K}} f_{j k} \cdot x_{k, t+z} \leq b_{j t}+U_{j t}
$$
...
$$
\sum_{k \in \mathcal{K}} \sum_{z=0}^{Z_{k}} f_{j k z} \cdot x_{k, t+z} \leq b_{j t}+U_{j t}
$$
...
für alle $j \in \mathcal{J}, t=1,2, \ldots, T$# Modell HPPPLANI 
...
Maximale Zusatzkapazität im Segment $j$ in Periode $t$ :# Modell HPPPLANJ 
...
| B | - | - | 25.00 | 30.00 | 25.00 | 30.00 | 20.00 | 0.00 |# Beispiel 2 Produkte, 8 Perioden 
